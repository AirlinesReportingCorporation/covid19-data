...
class App extends Component {
  ...
  render() {
    ...
    var data1 = [
      ...
      { x: 73, a: new Date(2021, 7, 15), b: -41.1 }
    ];
    ...
    var corporate = [
      ...
      { x: 73, a: new Date(2021, 7, 15), b: -62.4 }
    ];
    ...
    var online = [
      ...
      { x: 73, a: new Date(2021, 7, 15), b: -24.0 }
    ];
    ...
    var leisure = [
      ...
      { x: 73, a: new Date(2021, 7, 15), b: -43.4 }
    ];

    var ytdData2 = [-78.3, -37.1, -59.3];
