...
class App extends Component {
  ...
  render() {
    ...
    var data1 = [
      ...
      { x: 17, a: new Date(2020, 6, 19), b: -80.6 }
    ...
    var data2 = [
      ...
      { x: 17, a: new Date(2020, 6, 19), b: -88.0 }
    ];

    var ytdData1 = [-55.30, -61.01];
    ...
    var online = [
      ...
      { x: 17, a: new Date(2020, 6, 19), b: -73.8 }
    ];
    ...
    var ytdData2 = [-60.06, -51.95, -55.57];
