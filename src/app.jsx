...
class App extends Component {
  ...
  render() {
    ...
    var corporate = [
      ...
      { x: 34, a: new Date(2020, 10, 15), b: -84.9 }
    ];
    ...
    var online = [
      ...
      { x: 34, a: new Date(2020, 10, 15), b: -54.2 }
    ];
    ...
    var leisure = [
      ...
      { x: 34, a: new Date(2020, 10, 15), b: -68.2 }
    ];

    var ytdData2 = [-70.12, -53.59, -61.79];
