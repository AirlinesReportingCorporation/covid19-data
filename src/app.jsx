...
class App extends Component {
  ...
  render() {
    ...
    var data2 = [
      ...
      { x: 44, a: new Date(2021, 0, 24), b: -83.8 }
    ];

    var ytdData1 = [-67.66, -76.63];
    ...
    var online = [
      ...
      { x: 44, a: new Date(2021, 0, 24), b: -56.1 }
    ];
